...
class ShoppingListItem(BaseModel):
    ...
    planned_dates: list[date] = Field(default_factory=list, description="List of dates when this ingredient is needed")
...
class ShoppingSummary(BaseModel):
    ...
    categories: list[str] = Field(default_factory=list, description="List of ingredient categories")
...
class ShoppingList(BaseModel):
    ...
    total_items: int = Field(..., description="Total number of unique ingredients")
    generated_at: str = Field(..., description="ISO timestamp when the list was generated")
