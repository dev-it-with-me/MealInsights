...
import type { ShoppingListResponse } from "@/entities/shopping";
        ...
        <Stack gap="xs">
          ...
          <Group gap="md">
            ...
            <Text size="sm" color="dimmed">
              {formatDate(summary.date_range_start)} -{" "}
              {formatDate(summary.date_range_end)}
            </Text>
          </Group>
        </Stack>
        ...
        <Grid>
          ...
          <Grid.Col span={3}>
            <Stack gap={4} align="center">
              ...
              <Text size="sm">{formatDate(shoppingList.generated_at)}</Text>
            </Stack>
          </Grid.Col>
        </Grid>
      </Card>
