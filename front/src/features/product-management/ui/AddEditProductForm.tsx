...
import { IngredientSelector } from "@/shared/ui";
  ...
  useEffect(() => {
    if (isOpen && product && editingMode) {
      ...
      if (product.photo_url) {
        ...
        const dataUrl = product.photo_data.startsWith("data:")
          ? product.photo_data
          : `data:image/jpeg;base64,${product.photo_data}`;
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} ref={formRef}>
        <Stack gap="md">
          ...
          <div>
            ...
            {editingMode &&
              (product?.photo_url || product?.photo_data) &&
              !selectedPhoto &&
              !photoRemoved && (
                <div style={{ marginBottom: "12px" }}>
                  ...
                  >
                    <Image
                      src={
                        product.photo_url ||
                        (product.photo_data?.startsWith("data:")
                          ? product.photo_data
                          : `data:image/jpeg;base64,${product.photo_data}`)
                      }
                      alt={product.name}
          ...
          <NutritionGrid title="Nutritional Information (per 100g/ml)">
