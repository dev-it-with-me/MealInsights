...
import { Group, SegmentedControl, Button, Stack, Text } from "@/shared/ui-kit";
import { DatePickerInput, type DateValue } from "@/shared/ui-kit";
...
export const DateRangeSelector = ({
  ...
  const [tempStartDate, setTempStartDate] = useState<DateValue>(
    dateRange.startDate
  );
  ...
  const handleApplyDateRange = () => {
    if (tempStartDate && tempEndDate) {
      ...
      const startDate =
        tempStartDate instanceof Date ? tempStartDate : new Date(tempStartDate);
      const endDate =
        tempEndDate instanceof Date ? tempEndDate : new Date(tempEndDate);
