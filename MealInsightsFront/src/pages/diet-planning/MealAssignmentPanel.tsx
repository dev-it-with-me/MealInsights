...
import { IconCalendar, IconPlus, IconAlertCircle, IconClock } from '@tabler/icons-react';
import { notifications } from '@mantine/notifications';
import dayjs from 'dayjs';
import { MealSearchSelect } from './MealSearchSelect';
import { PlannedMealsListForDay } from './PlannedMealsListForDay';
import { useDayPlan, useCreateMealAssignment, useDeleteMealAssignment } from '../../entities/diet-planning/api/hooks';
                    ...
                    <div style={{ minHeight: '200px' }}>
                        {isDayPlanLoading ? (
                            <Stack align="center" justify="center" py="xl">
                                <Loader size="sm" />
                                <Text size="sm" c="dimmed">Loading meals...</Text>
                            </Stack>
                        ) : (
            ...
            <Card p="sm" withBorder>
                <Stack gap="sm">
                    ...
                    <TimeInput
                        ...
                        description="Set a specific time for this meal"
                    />
                    ...
                    <Textarea
                        ...
                        minRows={2}
                        maxRows={4}
                        description="Optional notes about dietary restrictions, preferences, etc."
                    />
