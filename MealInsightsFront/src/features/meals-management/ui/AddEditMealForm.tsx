          ...
          <Grid>
            <Grid.Col span={6}>
              <NumberInput
                ...
                onChange={(value) => form.setFieldValue('macros_total.protein', Number(value) || 0)}
              />
            </Grid.Col>
            <Grid.Col span={6}>
              <NumberInput
                ...
                onChange={(value) => form.setFieldValue('macros_total.carbohydrates', Number(value) || 0)}
              />
            </Grid.Col>
            <Grid.Col span={6}>
              <NumberInput
                ...
                onChange={(value) => form.setFieldValue('macros_total.sugar', Number(value) || 0)}
              />
            </Grid.Col>
            <Grid.Col span={6}>
              <NumberInput
                ...
                onChange={(value) => form.setFieldValue('macros_total.fat', Number(value) || 0)}
              />
            </Grid.Col>
            <Grid.Col span={6}>
              <NumberInput
                ...
                onChange={(value) => form.setFieldValue('macros_total.fiber', Number(value) || 0)}
              />
            </Grid.Col>
            <Grid.Col span={6}>
              <NumberInput
                ...
                onChange={(value) => form.setFieldValue('macros_total.saturated_fat', Number(value) || 0)}
              />
            </Grid.Col>
          </Grid>
