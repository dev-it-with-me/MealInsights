...
import { Button, Group, Text, Stack, Alert } from '@mantine/core';
...
export const GenerateShoppingListButton: React.FC<GenerateShoppingListButtonProps> = ({
    onGenerate,
    disabled,
    isLoading,
    dateRange,
    ...
    const getButtonText = () => {
        ...
        if (hasValidDateRange) {
            ...
            return `Generate Shopping List (${daysDiff} day${daysDiff !== 1 ? 's' : ''})`;
        }
